...
$sql="INSERT INTO firstA (p1,p2,p3,p4,p5,p6,year) values('$m1','$m2','$m3','$m4','$m5','$m6','first')";
$stmt=$conn->query($sql);
		
$sql1="INSERT INTO firstA (p1,p2,p3,p4,p5,p6,year) values('$t1','$t2','$t3','$t4','$t5','$t6','first')";
$stmt1=$conn->query($sql1);

$sql2="INSERT INTO firstA (p1,p2,p3,p4,p5,p6,year) values('$w1','$w2','$w3','$w4','$w5','$w6','first')";
$stmt2=$conn->query($sql2);

$sql3="INSERT INTO firstA (p1,p2,p3,p4,p5,p6,year) values('$tr1','$tr2','$tr3','$tr4','$tr5','$tr6','first')";
$stmt3=$conn->query($sql3);

$sql4="INSERT INTO firstA (p1,p2,p3,p4,p5,p6,year) values('$f1','$f2','$f3','$f4','$f5','$f6','first')";
$stmt4=$conn->query($sql4);
	}
	?>
	<div style="background-image: url(images/timetable/tt1.jpg); width:1000px; height:300px; margin-top:100px;
	margin-left:150px;">
<form action="tbFirstA.php" method="post">
